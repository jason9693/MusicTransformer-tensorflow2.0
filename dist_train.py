...
parser.add_argument('--load_path', default="model/mt-0615", help='모델 로드 경로')
parser.add_argument('--save_path', default="model/mt-0615", help='모델 저장 경로')
    ...
    for e in range(epochs):
        ...
        for b in range(len(dataset.files) // batch_size):
            ...
            if b % 100 == 0:
              ...
              mt.save_weights(save_path, save_format='tf')
              mt.load_weights(save_path)
